...
# C0111: Missing function docstring (missing-docstring)
	python3 -m pylint --disable=C0103,C0111,W1514 release.py setup.py
	python3 -m pylint adbe/*.py tests/*.py --disable=R0123,R0911,R0912,R0914,R0915,R1705,R1710,C0103,C0111,C0301,C0302,C1801,W0511,W0621,W0601,W0603
